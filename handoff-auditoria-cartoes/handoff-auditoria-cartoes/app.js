    ...
    let finDash = {
      ...
      openTabIds: ["dashboard", "conciliacao", "cartoes", "cobrancas", "folha", "config"],
    ...
    function refreshAcqUi() {
      ...
      if (finDash.tab === "config") renderFinModuleDash();
...
<body>
  <div class="wrap">
    ...
    /* ===== HANDOFF Â· GestÃ£o de Clientes (perfil e sub-abas liberados) ===== */
    (function initHandoffAuditoriaCartoes() {
      document.documentElement.classList.add("handoff-auditoria");
      document.title = "Handoff Â· GestÃ£o de Clientes";
      ...
      document.addEventListener("click", (e) => {
        ...
        if (topTab && topTab.dataset.id !== "clientes") {
          e.preventDefault();
          e.stopPropagation();
          toast("Handoff: permaneÃ§a em GestÃ£o de Clientes");
          return;
        }
        if (e.target.closest("[data-close-tab], [data-add-tab], #tabAddBtn, [data-switch-tab]")) {
          e.preventDefault();
          e.stopPropagation();
          toast("Handoff: navegaÃ§Ã£o de abas do sistema estÃ¡ bloqueada");
        }
      }, true);
